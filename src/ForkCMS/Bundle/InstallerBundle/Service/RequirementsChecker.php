    ...
    private function checkWebServer(): RequirementCategory
    {
        ...
        return new RequirementCategory(
            ...
            Requirement::check(
                ...
                'Your server is running at least php 7.0.0. <br>' . $reasoningBehindTheMinimumPHPVersion,
                'PHP version must be at least 7.0.0, Before using Fork CMS, upgrade your PHP installation, preferably to the latest version.<br>' . $reasoningBehindTheMinimumPHPVersion,
