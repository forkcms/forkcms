...
class CopyModulesToOtherLocalePass implements CompilerPassInterface
{
    public function process(ContainerBuilder $container)
    {
        ...
        // find all service IDs with the forkcms.copy_module_content_to_other_locale tag
        $taggedServices = $container->findTaggedServiceIds('forkcms.copy_module_content_to_other_locale');
