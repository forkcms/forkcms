...
class RecentArticlesList extends FrontendBaseWidget
{
    ...
    {
        // get RSS-link
        $rssTitle = $this->get('forkcms.settings')->get('Blog', 'rss_title_' . LANGUAGE, SITE_DEFAULT_TITLE);
        ...
        $this->template->assign(
            ...
            FrontendBlogModel::getAll($this->get('forkcms.settings')->get('Blog', 'recent_articles_list_num_items', 5))
        );
