...
class SeoFormNode extends \Twig_Node
{
    ...
    public function compile(Twig_Compiler $compiler): void
    {
        $compiler
            ...
            ->write('echo "<h2 class=\"tab-pane-title\">' . $this->lbl('Titles') . '</h2>";')
            ->write('echo \'</div>\';')
        ...
        $compiler
            ...
            ->write('echo \'<div class="panel panel-default">\';')
            ->write('echo \'<div class="panel-heading">\';')
            ->write('echo "<h2 class=\"tab-pane-title\">' . $this->lbl('MetaInformation') . '</h2>";')
            ->write('echo \'</div>\';')
            ->write('echo \'<div class="panel-body">\';')
            ->write('echo \'<div class="form-group">\';')
            ->write('echo \'<ul class="list-unstyled checkboxTextFieldCombo">\';')
            ...
            ->write('echo \'<div class="panel panel-default">\';')
            ->write('echo \'<div class="panel-heading">\';')
            ->write('echo "<h2 class=\"tab-pane-title\">' . $this->lbl('URL') . '</h2>";')
            ->write('echo \'</div>\';')
            ->write('echo \'<div class="panel-body">\';')
            ->write('echo \'<div class="form-group last">\';')
            ->write('echo \'<ul class="list-unstyled checkboxTextFieldCombo">\';')
        ...
        $compiler
            ...
            ->write('echo \'<div class="panel panel-default">\';')
            ->write('echo \'<div class="panel-heading">\';')
            ->write('echo "<h2 class=\"tab-pane-title\">' . $this->lbl('SEO') . '</h2>";')
            ->write('echo \'</div>\';')
            ->write('echo \'<div class="panel-body">\';')
