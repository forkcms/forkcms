...
class Edit extends BackendBaseActionEdit
{
    ...
    private function loadDataGrids(): void
    {
        ...
        $this->dataGridUsers->setColumnFunction('htmlspecialchars', ['[email]'], 'email');
        ...
        if (BackendAuthentication::isAllowedAction('Edit', 'Users')) {
            ...
            $this->dataGridUsers->setColumnFunction('htmlspecialchars', ['[nickname]'], 'nickname');
            $this->dataGridUsers->setColumnFunction('htmlspecialchars', ['[surname]'], 'surname');
            $this->dataGridUsers->setColumnFunction('htmlspecialchars', ['[name]'], 'name');
        }
    }
