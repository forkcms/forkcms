...
class Installer extends ModuleInstaller
{
    ...
    private function configureFrontendFilesDirectories(): void
    {
        ...
        $filesystem->mkdir(PATH_WWW . '/public/files/Profiles/Avatars/source/');
        $filesystem->mkdir(PATH_WWW . '/public/files/Profiles/Avatars/240x240/');
        $filesystem->mkdir(PATH_WWW . '/public/files/Profiles/Avatars/64x64/');
        $filesystem->mkdir(PATH_WWW . '/public/files/Profiles/Avatars/32x32/');
    }
