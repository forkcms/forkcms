...
{form:add}
  ...
  <p class="text-warning">{$lblNewProfileWillBeNotified|ucfirst}</p>
  {/option:notifyProfile}
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <div class="form-group">
            <label for="password">
              {$lblPassword|ucfirst}
              {option:!notifyProfile}<abbr class="glyphicon glyphicon-asterisk" title="{$lblRequiredField|ucfirst}"></abbr>{/option:!notifyProfile}
            </label>
