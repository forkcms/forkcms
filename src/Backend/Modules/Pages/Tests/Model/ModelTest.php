...
class ModelTest extends WebTestCase
{
    ...
    public function getTestTree(string $token): string
    {
        return '<h4>{$lblAuthenticationMainNavigation}</h4>'
               ...
               . '<ul>'
               . '<li id="page-1" rel=\'home\' data-jstree=\'{"type":"home"}\'>'
               . '<a href="/private/en/pages/edit?token=' . $token . '&id=1">'
               . '<ins>&#160;</ins>Home</a>'
               . '<ul>'
               . '<li id="page-407" rel=\'page\' data-jstree=\'{"type":"page"}\'>'
               . '<a href="/private/en/pages/edit?token=' . $token . '&id=407">'
               . '<ins>&#160;</ins>Blog</a>'
               . '</li>'
               . '<li id="page-408" rel=\'page\' data-jstree=\'{"type":"page"}\'>'
               . '<a href="/private/en/pages/edit?token=' . $token . '&id=408">'
               . '<ins>&#160;</ins>FAQ</a>'
               . '</li>'
               . '<li id="page-409" rel=\'page\' data-jstree=\'{"type":"page"}\'>'
               . '<a href="/private/en/pages/edit?token=' . $token . '&id=409">'
               . '<ins>&#160;</ins>Contact</a>'
               . '</li>'
               . '</ul>'
               . '</li>'
               ...
               . '<a href="/private/en/pages/edit?token=' . $token . '&id=2">'
               . '<ins>&#160;</ins>Sitemap</a>'
               . '</li>'
               . '<li id="page-3" rel=\'page\' data-jstree=\'{"type":"page"}\'>'
               . '<a href="/private/en/pages/edit?token=' . $token . '&id=3">'
