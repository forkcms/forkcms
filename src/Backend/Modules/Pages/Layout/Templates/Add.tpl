...
{form:add}
	...
	<div class="row fork-module-content">
		...
		<div class="col-md-12">
			<a id="generatedUrl" data-url="{$SITE_URL}{$prefixURL}/" href="{$SITE_URL}{$prefixURL}/">{$SITE_URL}{$prefixURL}/</a>
		</div>
	</div>
	<div class="row fork-module-content">
		<div class="col-md-12">
					...
					<div role="tabpanel" class="tab-pane active" id="tabContent">
						<div id="editTemplate" class="row">
							<div class="col-md-12">
								...
								<div class="btn-toolbar pull-right">
									<div class="btn-group" role="group">
										<a id="changeTemplate" href="#" class="btn" title="{$lblChangeTemplate|ucfirst}">
												...
												<table cellspacing="2">
													...
													<tr>
														<td data-position="fallback" id="templatePosition-fallback" colspan="1" class="box">
															<div class="heading linkedBlocksTitle"><h4>{$lblFallback|ucfirst}</h4></div>
