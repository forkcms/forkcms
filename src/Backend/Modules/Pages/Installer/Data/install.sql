CREATE TABLE IF NOT EXISTS `pages` (
 ...
 `type` VARCHAR(255) NOT NULL default 'root' COMMENT 'page, header, footer, ...',
 `title` varchar(255) NOT NULL,
 `navigation_title` varchar(255) NOT NULL COMMENT 'title that will be used in the navigation',
 `navigation_title_overwrite` VARCHAR(1) NOT NULL default 'N' COMMENT 'should we override the navigation title',
 `hidden` VARCHAR(1) NOT NULL default 'N' COMMENT 'is the page hidden?',
 `status` VARCHAR(243) NOT NULL default 'active' COMMENT 'is this the active, archive or draft version',
 `publish_on` datetime NOT NULL,
 `data` text COMMENT 'serialized array that may contain type specific parameters',
 `created_on` datetime NOT NULL,
 `edited_on` datetime NOT NULL,
 `allow_move` VARCHAR(1) NOT NULL default 'Y',
 `allow_children` VARCHAR(1) NOT NULL default 'Y',
 `allow_edit` VARCHAR(1) NOT NULL default 'Y',
