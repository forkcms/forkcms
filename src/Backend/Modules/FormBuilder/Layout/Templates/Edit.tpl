...
{form:edit}
	...
	<div class="tabs">
		...
		<div id="tabConfirmationMail" class="box">
			...
			<div class="horizontal">
				<p>
					{$chkSendConfirmationMail} <label for="mail_send">{$lblConfirmationMail|ucfirst}</label>
				</p>
					...
					<div class="box boxLevel2" id="formElements">
						...
						<div class="options">
							...
							<ul>
								...
								<li id="datetimeSelector"><a href="#datetime" rel="datetimeDialog" class="openFieldDialog">{$lblDatetime|ucfirst}</a></li>
