...
final class Reset extends ActionDelete
{
    ...
    {
        $this->get('forkcms.settings')->delete($this->getModule(), 'certificate');
        $this->get('forkcms.settings')->delete($this->getModule(), 'email');
        $this->get('forkcms.settings')->delete($this->getModule(), 'account');
