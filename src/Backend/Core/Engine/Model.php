...
class Model extends \BaseModel
{
     ...
     * @param  string[optional] $action         The action this extra will use.
     * @param  string[optional] $label          Label which will be used when you want to connect this block.
     * @param  array            $data[optional] Containing extra variables, will be saved as serialized.
     * @param  bool[optional]   $hidden         Should this extra be visible in frontend or not?
     * @param  int[optional]    $sequence       Enter a sequence integer or it will be generated by default
