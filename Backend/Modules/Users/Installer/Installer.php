...
class UsersInstaller extends ModuleInstaller
{
    ...
    private function addUser()
    {
        ...
        if (!(bool) $this->getDB()->getVar(
            ...
            // store files
            $fs->dumpFile(
                PATH_WWW . '/frontend/files/backend_users/avatars/source/god.jpg',
                base64_decode($avatar124x124)
            );
            $fs->dumpFile(
                PATH_WWW . '/frontend/files/backend_users/avatars/128x128/god.jpg',
                base64_decode($avatar124x124)
            );
            $fs->dumpFile(
                PATH_WWW . '/frontend/files/backend_users/avatars/64x64/god.jpg',
                base64_decode($avatar64x64)
            );
            $fs->dumpFile(
                PATH_WWW . '/frontend/files/backend_users/avatars/32x32/god.jpg',
