	...
	<div id="container">
		...
		<div class="cols id1">
			<div class="col col-6 content">
				...
				<p>Since PHP 5.3 the <a href="http://php.net/spl"><span class="caps">SPL</span>-extension</a> is loaded by default, so this is only important if you use PHp 5.2. <span class="caps">SPL</span> stands for Standard PHP Library and is a collection of interfaces and classes that can be use to solver standard problems.</p>
