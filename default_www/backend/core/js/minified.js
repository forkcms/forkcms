...
(function($)
{
	$.fn.passwordGenerator = function(options) 
	{
		...
		return this.each(function() 
		{
			$(this).parent().addClass('oneLiner');
			
			// append the button
			$(this).after('<span><a href="#" class="button">' + options.generateLabel + '</a></span>');
