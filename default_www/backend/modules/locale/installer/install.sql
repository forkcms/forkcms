...
INSERT INTO `locale` (`user_id`, `language`, `application`, `module`, `type`, `name`, `value`, `edited_on`) VALUES
(1, 'nl', 'backend', 'locale', 'lbl', 'Add', 'vertaling toevoegen', '2010-06-15 13:25:48'),
(1, 'nl', 'backend', 'locale', 'msg', 'HelpName', 'De Engelstalige referentie naar de vertaling, bvb. "Add".', '2010-06-16 08:53:13'),
(1, 'nl', 'backend', 'locale', 'msg', 'HelpValue', 'De vertaling zelf, bvb. "toevoegen".', '2010-06-16 07:49:53'),
(1, 'nl', 'backend', 'locale', 'msg', 'HelpAddName', 'De Engelstalige referentie naar de vertaling, bvb. "Add". Deze waarde moet beginnen met een hoofdletter en mag geen spaties bevatten.', '2010-06-16 08:53:04'),
(1, 'nl', 'backend', 'locale', 'msg', 'HelpAddValue', 'De vertaling zelf, bvb. "toevoegen".', '2010-06-16 07:45:19'),
(1, 'nl', 'backend', 'locale', 'msg', 'HelpEditName', 'De Engelstalige referentie naar de vertaling, bvb. "Add". Deze waarde moet beginnen met een hoofdletter en mag geen spaties bevatten.', '2010-06-16 08:53:10'),
(1, 'nl', 'backend', 'locale', 'msg', 'HelpEditValue', 'De vertaling zelf, bvb. "toevoegen".', '2010-06-16 07:51:28'),
(1, 'nl', 'backend', 'locale', 'err', 'AlreadyExists', 'Deze vertaling bestaat reeds.', '2010-06-16 07:57:22'),
(1, 'nl', 'backend', 'locale', 'err', 'ModuleHasToBeCore', 'De module moet core zijn voor vertalingen in de frontend.', '2010-06-16 08:05:52'),
(1, 'nl', 'backend', 'locale', 'msg', 'Added', 'De vertaling "%1$s" werd toegevoegd.', '2010-06-16 08:30:12'),
(1, 'nl', 'backend', 'locale', 'msg', 'Edited', 'De vertaling "%1$s" werd opgeslagen.', '2010-06-23 14:02:43'),
(1, 'nl', 'backend', 'locale', 'msg', 'Deleted', 'De geselecteerde vertalingen werden verwijderd.', '2010-06-22 12:08:40'),
(1, 'nl', 'backend', 'locale', 'err', 'NoSelection', 'Er waren geen vertalingen geselecteerd.', '2010-06-23 15:42:48'),
(1, 'nl', 'backend', 'locale', 'msg', 'EditTranslation', 'bewerk vertaling "%1$s"', '2010-06-16 12:01:52'),
(1, 'nl', 'backend', 'locale', 'msg', 'NoItems', 'Er zijn nog geen vertalingen. <a href="%1$s">Voeg de eerste vertaling toe</a>.', '2010-06-23 15:42:29'),
(1, 'nl', 'backend', 'locale', 'msg', 'NoItemsAnalyse', 'Er werden geen ontbrekende vertalingen gevonden.', '2010-06-30 12:53:48');


INSERT INTO `locale` (`user_id`, `language`, `application`, `module`, `type`, `name`, `value`, `edited_on`) VALUES
(1, 'nl', 'frontend', 'core', 'act', 'Archive', 'archief', '2010-07-08 12:19:29'),
(1, 'nl', 'frontend', 'core', 'act', 'Category', 'categorie', '2010-07-01 08:00:05'),
(1, 'nl', 'frontend', 'core', 'act', 'Comment', 'reageer', '2010-07-01 07:51:45'),
(1, 'nl', 'frontend', 'core', 'act', 'Comments', 'reacties', '2010-07-01 07:56:29'),
(1, 'nl', 'frontend', 'core', 'act', 'Detail', 'detail', '2010-06-17 11:49:43'),
(1, 'nl', 'frontend', 'core', 'act', 'Rss', 'rss', '2010-07-05 09:44:24'),
(1, 'nl', 'frontend', 'core', 'err', 'AuthorIsRequired', 'Auteur is een verplicht veld.', '2010-07-01 08:56:37'),
(1, 'nl', 'frontend', 'core', 'err', 'EmailIsInvalid', 'Gelieve een geldig emailadres in te geven.', '2010-07-06 09:09:29'),
(1, 'nl', 'frontend', 'core', 'err', 'EmailIsRequired', 'E-mail is een verplicht veld.', '2010-07-01 08:57:05'),
(1, 'nl', 'frontend', 'core', 'err', 'FormError', 'Er ging iets mis, kijk de gemarkeerde velden na.', '2010-07-06 09:09:45'),
(1, 'nl', 'frontend', 'core', 'err', 'InvalidURL', 'Dit is een ongeldige URL.', '2010-07-01 08:58:43'),
(1, 'nl', 'frontend', 'core', 'err', 'MessageIsRequired', 'Bericht is een verplicht veld.', '2010-07-01 08:57:29'),
(1, 'nl', 'frontend', 'core', 'err', 'NameIsRequired', 'Gelieve een naam in te geven.', '2010-07-06 09:10:02'),
(1, 'nl', 'frontend', 'core', 'lbl', 'Archive', 'archief', '2010-07-01 13:33:30'),
(1, 'nl', 'frontend', 'core', 'lbl', 'By', 'door', '2010-07-01 07:52:16'),
(1, 'nl', 'frontend', 'core', 'lbl', 'Category', 'categorie', '2010-07-01 07:44:39'),
(1, 'nl', 'frontend', 'core', 'lbl', 'Comment', 'reactie', '2010-07-01 08:01:31'),
(1, 'nl', 'frontend', 'core', 'lbl', 'CommentedOn', 'reageerde op', '2010-07-05 14:51:15'),
(1, 'nl', 'frontend', 'core', 'lbl', 'Comments', 'reacties', '2010-07-01 07:52:09'),
(1, 'nl', 'frontend', 'core', 'lbl', 'Date', 'datum', '2010-07-01 08:00:17'),
(1, 'nl', 'frontend', 'core', 'lbl', 'Email', 'e-mail', '2010-07-01 07:52:34'),
(1, 'nl', 'frontend', 'core', 'lbl', 'GoTo', 'ga naar', '2010-07-01 13:19:32'),
(1, 'nl', 'frontend', 'core', 'lbl', 'GoToPage', 'ga naar pagina', '2010-07-01 13:39:26'),
(1, 'nl', 'frontend', 'core', 'lbl', 'In', 'in', '2010-07-05 12:00:36'),
(1, 'nl', 'frontend', 'core', 'lbl', 'Message', 'bericht', '2010-07-01 07:52:43'),
(1, 'nl', 'frontend', 'core', 'lbl', 'Name', 'naam', '2010-07-01 07:52:29'),
(1, 'nl', 'frontend', 'core', 'lbl', 'NextPage', 'volgende pagina', '2010-07-01 07:50:26'),
(1, 'nl', 'frontend', 'core', 'lbl', 'On', 'op', '2010-07-01 07:43:20'),
(1, 'nl', 'frontend', 'core', 'lbl', 'PreviousPage', 'vorige pagina', '2010-07-01 07:50:58'),
(1, 'nl', 'frontend', 'core', 'lbl', 'RecentComments', 'recente reacties', '2010-07-05 14:47:24'),
(1, 'nl', 'frontend', 'core', 'lbl', 'RequiredField', 'verplicht veld', '2010-07-01 08:02:59'),
(1, 'nl', 'frontend', 'core', 'lbl', 'Send', 'verstuur', '2010-07-06 09:10:14'),
(1, 'nl', 'frontend', 'core', 'lbl', 'Tags', 'tags', '2010-07-01 07:45:20'),
(1, 'nl', 'frontend', 'core', 'lbl', 'Title', 'titel', '2010-07-01 11:53:59'),
(1, 'nl', 'frontend', 'core', 'lbl', 'Website', 'website', '2010-07-01 08:54:07'),
(1, 'nl', 'frontend', 'core', 'lbl', 'WrittenOn', 'geschreven op', '2010-07-01 07:43:09'),
(1, 'nl', 'frontend', 'core', 'lbl', 'YouAreHere', 'je bent hier', '2010-07-05 14:49:58'),
(1, 'nl', 'frontend', 'core', 'msg', 'Comment', 'reageer', '2010-07-01 08:02:45'),
(1, 'nl', 'frontend', 'core', 'msg', 'TagsNoItems', 'Er zijn nog geen tags gebruikt.', '2010-07-06 09:10:36'),
(1, 'nl', 'frontend', 'core', 'msg', 'WrittenBy', 'geschreven door %1$s', '2010-07-01 07:44:11');