...
class MailmotorInstall extends ModuleInstaller
{
	...
	private function installLocaleEN()
	{
		...
		$this->insertLocale('en', 'backend', 'mailmotor', 'lbl', 'ImportGroups', 'import groups from CampaignMonitor');
		...
		$this->insertLocale('en', 'backend', 'mailmotor', 'lbl', 'NoDefaultsSet', 'not all default groups were set.');
	...
	private function installLocaleNL()
	{
		...
		$this->insertLocale('nl', 'backend', 'mailmotor', 'lbl', 'ImportGroups', 'importeer doelgroepen uit CampaignMonitor');
		$this->insertLocale('nl', 'backend', 'mailmotor', 'lbl', 'Ip', 'IP address');
		...
		$this->insertLocale('nl', 'backend', 'mailmotor', 'lbl', 'NoDefaultsSet', 'niet alle standaard-doelgroepen zijn ingesteld.');
		...
		$this->insertLocale('nl', 'backend', 'mailmotor', 'msg', 'GroupsImported', 'Er werden %1$s groep(en) met %2$s adressen ge&iuml;mporteerd uit CampaignMonitor. Vergeet niet de standaard-doelgroep per taal in te stellen!');
		...
		$this->insertLocale('nl', 'backend', 'mailmotor', 'msg', 'ImportRecentlyFailed', 'Niet alle adressen werden ge&iuml;mporteerd.');
