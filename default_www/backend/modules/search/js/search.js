...
jsBackend.search = {
	init: function() {
		// synonyms box
		if($('input.synonymBox').length > 0) { $('input.synonymBox').tagBox({ emptyMessage: '{$msgSearchNoSynonyms}', addLabel: '{$lblAdd|ucfirst}', removeLabel: '{$lblDeleteSynonym|ucfirst}', autoCompleteUrl: '', showIconOnly: false }); }
