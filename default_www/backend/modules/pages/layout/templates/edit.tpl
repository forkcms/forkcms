...
{form:edit}
	...
	<div class="pageTitle">
		...
		<div class="buttonHolderRight">
			...
			{option:!item.is_hidden}
				<a href="{$SITE_URL}{$item.full_url}{option:item.revision_id}?revision={$item.revision_id}{/option:item.revision_id}" class="button icon iconZoom previewButton targetBlank">
	...
	<p id="pagesPageTitle">
		...
		<span class="oneLiner">
			<span><a href="{$SITE_URL}{$prefixURL}/{$item.url}{option:item.revision_id}?revision={$item.revision_id}{/option:item.revision_id}">{$SITE_URL}{$prefixURL}/<span id="generatedUrl">{$item.url}</span></a></span>
		</span>
	</p>
