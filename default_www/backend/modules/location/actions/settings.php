...
class BackendLocationSettings extends BackendBaseActionEdit
{
	...
	private function loadForm()
	{
		...
		$this->frm->addDropdown('zoom_level', array_combine(array_merge(array('auto'), range(3, 18)), array_merge(array(BL::getLabel('Auto', 'location')), range(3, 18))), BackendModel::getModuleSetting($this->URL->getModule(), 'zoom_level', 'auto'));
		...
		$this->frm->addDropdown('map_type', array('ROADMAP' => BL::getLabel('Roadmap', 'location'), 'SATELLITE' => BL::getLabel('Satellite', 'location'), 'HYBRID' => BL::getLabel('Hybrid', 'location'), 'TERRAIN' => BL::getLabel('Terrain', 'location')), BackendModel::getModuleSetting($this->URL->getModule(), 'map_type', 'roadmap'));

		// add map info (widgets)
		$this->frm->addDropdown('zoom_level_widget', array_combine(array_merge(array('auto'), range(3, 18)), array_merge(array(BL::getLabel('Auto', 'location')), range(3, 18))), BackendModel::getModuleSetting($this->URL->getModule(), 'zoom_level_widget', 13));
		...
		$this->frm->addDropdown('map_type_widget', array('ROADMAP' => BL::getLabel('Roadmap', 'location'), 'SATELLITE' => BL::getLabel('Satellite', 'location'), 'HYBRID' => BL::getLabel('Hybrid', 'location'), 'TERRAIN' => BL::getLabel('Terrain', 'location')), BackendModel::getModuleSetting($this->URL->getModule(), 'map_type_widget', 'roadmap'));
	}
