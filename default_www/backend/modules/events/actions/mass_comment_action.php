 ...
 * @since		2.0
 */
class BackendEventsMassCommentAction extends BackendBaseAction
{
	/**
	 * Execute the action
	 *
	...
	public function execute()
	{
		...
		else
		{
			...
			// delete comment(s)
			if($action == 'delete') BackendEventsModel::deleteComments($ids);
			...
			elseif($action == 'spam')
			{
				...
				{
					// get data
					$comments = BackendEventsModel::getComments($ids);
				...
				// set new status
				BackendEventsModel::updateCommentStatuses($ids, $action);
			}
