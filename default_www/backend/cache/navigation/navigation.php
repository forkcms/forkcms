...
$navigation[2]['children'][8] = array('url' => 'events/index', 'label' => 'Events');
$navigation[2]['children'][8]['children'][0] = array('url' => 'events/index', 'label' => 'Events', 'selected_for' => array('events/add', 'events/edit'));
$navigation[2]['children'][8]['children'][1] = array('url' => 'events/comments', 'label' => 'Comments', 'selected_for' => array('events/edit_comment'));
$navigation[2]['children'][8]['children'][2] = array('url' => 'events/categories', 'label' => 'Categories', 'selected_for' => array('events/add_category', 'events/edit_category'));
