	...
	<div>
		...
		<div class="horizontal">
			...
			<div id="requirementsInformation">
				...
				<h4>cURL: <span class="{$extensionCURL}">{$extensionCURL}</span></h4>
				<p>
				...
				<h4>libxml: <span class="{$extensionLibXML}">{$extensionLibXML}</span></h4>
				<p>
				...
				<h4>DOM: <span class="{$extensionDOM}">{$extensionDOM}</span></h4>
				<p>
				...
				<h4>SimpleXML: <span class="{$extensionSimpleXML}">{$extensionSimpleXML}</span></h4>
				<p>
				...
				<h4>SPL: <span class="{$extensionSPL}">{$extensionSPL}</span></h4>
				<p>
				...
				<h4>PDO: <span class="{$extensionPDO}">{$extensionPDO}</span></h4>
				<p>
				...
				<h4>PDO MySQL driver: <span class="{$extensionPDOMySQL}">{$extensionPDOMySQL}</span></h4>
				<p>
				...
				<h4>mb_string: <span class="{$extensionMBString}">{$extensionMBString}</span></h4>
				<p>
				...
				<h4>iconv: <span class="{$extensionIconv}">{$extensionIconv}</span></h4>
				<p>
				...
				<h4>GD2: <span class="{$extensionGD2}">{$extensionGD2}</span></h4>
				<p>
				...
				<h4>{$PATH_WWW}/backend/cache/* <span class="{$fileSystemBackendCache}">{$fileSystemBackendCache}</span></h4>
				...
				<h4>{$PATH_WWW}/frontend/cache/* <span class="{$fileSystemFrontendCache}">{$fileSystemFrontendCache}</span></h4>
				...
				<h4>{$PATH_WWW}/frontend/files/* <span class="{$fileSystemFrontendFiles}">{$fileSystemFrontendFiles}</span></h4>
...
*}
				...
				<h4>{$PATH_LIBRARY}/config.base.php <span class="{$fileSystemConfig}">{$fileSystemConfig}</span></h4>
				<p>This file is used to create the application config file.</p>

				<h4>{$PATH_LIBRARY}/globals.base.php <span class="{$fileSystemGlobals}">{$fileSystemGlobals}</span></h4>
				<p>This file is used to create the global configuration file.</p>

				<h4>{$PATH_LIBRARY}/globals_backend.base.php <span class="{$fileSystemGlobalsBackend}">{$fileSystemGlobalsBackend}</span></h4>
				<p>This file is used to create the global backend configuration file.</p>

				<h4>{$PATH_LIBRARY}/globals_frontend.base.php <span class="{$fileSystemGlobalsFrontend}">{$fileSystemGlobalsFrontend}</span></h4>
				<p>This file is used to create the global frontend configuration file.</p>

				<h4>{$PATH_LIBRARY} <span class="{$fileSystemPathLibrary}">{$fileSystemPathLibrary}</span></h4>
