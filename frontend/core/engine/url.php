...
class FrontendURL extends KernelLoader
{
     ...
     * @param string [optional] $type  The return type, possible
     *                     values are: bool, boolean, int, integer, float,
     *                     double, string, array.
     * @param mixed  [optional] $defaultValue The value that should be
