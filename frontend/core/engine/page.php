...
class FrontendPage extends FrontendBaseObject
{
	...
	/**
	 * Create a new FrontendPage instance for the given page ID.
	 * If the page ID is not given, it is determined based on the URL path.
	 * @param int $pageId
	 */
	...
	protected function getPageContent()
	{
		...
		if(empty($this->record) && $this->pageId != 404) FrontendNavigation::showPage(404);
