$(document).ready(function() {
	...
	$('#headerSearch input').focus(function() {
		$('#headerSearch').addClass('inputHolderActive');
	});
	$('#headerSearch input').blur(function() {
		$('#headerSearch').removeClass('inputHolderActive');
	});

	$('#footerSearch input').focus(function() {
		$('#footerSearch').addClass('inputHolderActive');
	});
	$('#footerSearch input').blur(function() {
		$('#footerSearch').removeClass('inputHolderActive');
	});
