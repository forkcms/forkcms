		...
		{iteration:items}
			<article class="mod">
				<div class="inner">
					...
					<div class="bd content">
						{option:items.image}<img src="{$SITE_URL}/image.php?module=blog&amp;action=images&amp;width=250&amp;height=150&amp;crop=true&amp;file=asdf{$items.image}" alt="{$items.title}" />{/option:items.image}
