...
class FrontendBlogArchive extends FrontendBaseBlock
{
	...
	private function getData()
	{
		...
		if(mb_strlen($this->year) != 4) FrontendNavigation::showPage(404);
		...
		// validate parameters
		if($this->year == 0 || $this->month === 0) FrontendNavigation::showPage(404);
		...
		if($requestedPage > $this->pagination['num_pages'] || $requestedPage < 1) FrontendNavigation::showPage(404);
