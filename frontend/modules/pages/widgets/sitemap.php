...
class FrontendPagesWidgetSitemap extends FrontendBaseWidget
{
	...
	public function execute()
	{
		...
		/*
		 * A bit dirty this; we overwrite the template path of the FrontendNavigation with
		 * a separate template for the sitemap.
		 */
		$widgetLayoutPath = FRONTEND_MODULES_PATH . '/pages/layout';
		$originalTemplatePath = FrontendNavigation::getTemplatePath();
		FrontendNavigation::setTemplatePath($widgetLayoutPath . '/templates/sitemap.tpl');
		 ...
		 */
		$sitemapNavigationHTML = $this->tpl->getContent($widgetLayoutPath . '/widgets/sitemap.tpl');
