...
> The example below shows you how easy it is to add custom galleries to your custom module. We show you how to add an "images" and "trailers" MediaGroup.
...
You will also need to add set `$this->group = $group` in your constructor (and `create`) and `update` method.
...
Example: `Backend/Modules/MediaGalleries/Domain/MediaGallery/MediaGalleryType.php#L92`
...
Example: `src/Backend/Modules/MediaGalleries/Domain/MediaGallery/Command/CreateMediaGallery.php`

Example line: `src/Backend/Modules/MediaGalleries/Domain/MediaGallery/Command/CreateMediaGallery.php#L64`

### In your Create Command Handler class

Don't forget to inject your new MediaGroup into your CustomEntity.

Example line: `src/Backend/Modules/MediaGalleries/Domain/MediaGallery/Command/CreateMediaGalleryHandler.php#L35` 
...
**In your __construct()**
```php
$this->mediaGroup = $customEntity->getGroup();
```
...
Example: `src/Backend/Modules/MediaGalleries/Domain/MediaGallery/Command/UpdateMediaGallery.php#L61`
...
This will result in:
![Screenshow of the Backend Meda Helper](https://github.com/forkcms/forkcms/raw/master/docs/07.%media%20library/assets/integration-example-01.png)
