...
* Fast image builds.
* Any teammember can quickly boot up your project because the Dockerfile and docker-compose file is added to your version control.
...
### XDebug
XDebug is one of the most popular tools to debug your PHP application. It's easy to set up in PHPStorm. 
...
- Restart/rebuild your Docker containers, because you modified the environment variables:
```
