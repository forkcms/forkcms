...
* [Running ForkCMS on Docker](#running-forkcms-on-docker)
  * [Installing Docker on Mac/Windows](#installing-docker-on-mac-windows)
...
[Video - watch how to setup PHPStorm and Xdebug](https://d.pr/v/Xq1uYJ)
...
listens on port 9000 (should be default configuration). ![Configuring XDebug in PHPStorm](assets/phpstorm-xdebug1.png)
...
![Start listening for incoming debug connections](assets/phpstorm-xdebug3.png). Now, open your browser and visit the page you
...
[Video - watch how to setup PHPStorm with PHPUnit](http://d.pr/v/Pe2gVY)
