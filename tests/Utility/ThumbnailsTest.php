...
{
    // test images
    private const IMAGE_SQUARE = 'square.png';
    private const IMAGE_LANDSCAPE = 'landscape.png';
    private const IMAGE_PORTRAIT = 'portrait.png';
    ...
    private const IMAGE_DIMENSIONS = [
        self::IMAGE_SQUARE => '200x200',
        self::IMAGE_LANDSCAPE => '200x100',
        self::IMAGE_PORTRAIT => '100x200',
    ];
    ...
    private const SMALLER_WIDTH_SMALLER_HEIGHT = '<,<';
    private const EQUAL_WIDTH_SMALLER_HEIGHT = '=,<';
    private const GREATER_WIDTH_SMALLER_HEIGHT = '>,<';
    private const SMALLER_WIDTH_EQUAL_HEIGHT = '<,=';
    private const EQUAL_WIDTH_EQUAL_HEIGHT = '=,=';
    private const GREATER_WIDTH_EQUAL_HEIGHT = '>,=';
    private const SMALLER_WIDTH_GREATER_HEIGHT = '<,>';
    private const EQUAL_WIDTH_GREATER_HEIGHT = '=,>';
    private const GREATER_WIDTH_GREATER_HEIGHT = '>,>';
    private const SMALLER_WIDTH_PROPORTIONAL_HEIGHT = '<,*';
    private const EQUAL_WIDTH_PROPORTIONAL_HEIGHT = '=,*';
    private const GREATER_WIDTH_PROPORTIONAL_HEIGHT = '>,*';
    private const PROPORTIONAL_WIDTH_SMALLER_HEIGHT = '*,<';
    private const PROPORTIONAL_WIDTH_EQUAL_HEIGHT = '*,=';
    private const PROPORTIONAL_WIDTH_GREATER_HEIGHT = '*,>';

    private const EXPECTED_RESIZE_RESULTS = [
        self::SMALLER_WIDTH_SMALLER_HEIGHT => [
            self::IMAGE_LANDSCAPE => '50x50',
            self::IMAGE_PORTRAIT => '50x50',
            self::IMAGE_SQUARE => '50x50',
        ],
        self::EQUAL_WIDTH_SMALLER_HEIGHT => [
            self::IMAGE_LANDSCAPE => '200x50',
            self::IMAGE_PORTRAIT => '100x100',
            self::IMAGE_SQUARE => '200x100',
        ],
        self::GREATER_WIDTH_SMALLER_HEIGHT => [
            self::IMAGE_LANDSCAPE => '300x50',
            self::IMAGE_PORTRAIT => '100x300',
            self::IMAGE_SQUARE => '300x100',
        ],
        self::SMALLER_WIDTH_EQUAL_HEIGHT => [
            self::IMAGE_LANDSCAPE => '100x100',
            self::IMAGE_PORTRAIT => '50x200',
            self::IMAGE_SQUARE => '100x200',
        ],
        self::EQUAL_WIDTH_EQUAL_HEIGHT => [
            self::IMAGE_LANDSCAPE => '200x100',
            self::IMAGE_PORTRAIT => '100x200',
            self::IMAGE_SQUARE => '200x200',
        ],
        self::GREATER_WIDTH_EQUAL_HEIGHT => [
            self::IMAGE_LANDSCAPE => '300x100',
            self::IMAGE_PORTRAIT => '200x200',
            self::IMAGE_SQUARE => '300x200',
        ],
        self::SMALLER_WIDTH_GREATER_HEIGHT => [
            self::IMAGE_LANDSCAPE => '100x200',
            self::IMAGE_PORTRAIT => '50x300',
            self::IMAGE_SQUARE => '100x300',
        ],
        self::EQUAL_WIDTH_GREATER_HEIGHT => [
            self::IMAGE_LANDSCAPE => '200x200',
            self::IMAGE_PORTRAIT => '100x300',
            self::IMAGE_SQUARE => '200x300',
        ],
        self::GREATER_WIDTH_GREATER_HEIGHT => [
            self::IMAGE_LANDSCAPE => '300x300',
            self::IMAGE_PORTRAIT => '300x300',
            self::IMAGE_SQUARE => '300x300',
        ],
        self::SMALLER_WIDTH_PROPORTIONAL_HEIGHT => [
            self::IMAGE_LANDSCAPE => '100x50',
            self::IMAGE_PORTRAIT => '50x100',
            self::IMAGE_SQUARE => '100x100',
        ],
        self::EQUAL_WIDTH_PROPORTIONAL_HEIGHT => [
            self::IMAGE_LANDSCAPE => '200x100',
            self::IMAGE_PORTRAIT => '100x200',
            self::IMAGE_SQUARE => '200x200',
        ],
        self::GREATER_WIDTH_PROPORTIONAL_HEIGHT => [
            self::IMAGE_LANDSCAPE => '400x200',
            self::IMAGE_PORTRAIT => '200x400',
            self::IMAGE_SQUARE => '400x400',
        ],
        self::PROPORTIONAL_WIDTH_SMALLER_HEIGHT => [
            self::IMAGE_LANDSCAPE => '100x50',
            self::IMAGE_PORTRAIT => '50x100',
            self::IMAGE_SQUARE => '100x100',
        ],
        self::PROPORTIONAL_WIDTH_EQUAL_HEIGHT => [
            self::IMAGE_LANDSCAPE => '200x100',
            self::IMAGE_PORTRAIT => '100x200',
            self::IMAGE_SQUARE => '200x200',
        ],
        self::PROPORTIONAL_WIDTH_GREATER_HEIGHT => [
            self::IMAGE_LANDSCAPE => '400x200',
            self::IMAGE_PORTRAIT => '200x400',
            self::IMAGE_SQUARE => '400x400',
        ],
