...
CREATE TABLE `content_blocks` (
  ...
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `text` text COLLATE utf8mb4_unicode_ci,
  `hidden` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'N' COMMENT '(DC2Type:enum_bool)',
...
CREATE TABLE `faq_questions` (
  ...
  `hidden` VARCHAR(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'N',
  `sequence` int(11) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `pages` (
  ...
  `navigation_title_overwrite` VARCHAR(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'N' COMMENT 'should we override the navigation title',
  `hidden` VARCHAR(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'N' COMMENT 'is the page hidden?',
  ...
  `created_on` datetime NOT NULL,
  `edited_on` datetime NOT NULL,
  `allow_move` VARCHAR(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Y',
  `allow_children` VARCHAR(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Y',
  `allow_edit` VARCHAR(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Y',
  `allow_delete` VARCHAR(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Y',
  `sequence` int(11) NOT NULL,
  PRIMARY KEY (`revision_id`),
...
CREATE TABLE `themes_templates` (
  ...
  `active` VARCHAR(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Y' COMMENT 'Is this template active (as in: will it be used).',
