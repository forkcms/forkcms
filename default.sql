...
--
-- Host: localhost
-- Generation Time: Nov 19, 2008 at 04:29 PM
...
INSERT INTO meta VALUES(2, 'links', 'N', 'links', 'N', 'link', 'N', 'links', 'N', NULL);
INSERT INTO meta VALUES(3, 'sitemap', 'N', 'sitemap', 'N', 'sitemap', 'N', 'sitemap', 'N', NULL);
...
CREATE TABLE IF NOT EXISTS modules (
  id int(11) NOT NULL COMMENT 'Module-id for internal usage',
  `name` varchar(255) NOT NULL COMMENT 'A unique name',
  label varchar(255) NOT NULL COMMENT 'The label that will be used in the backend',
  active enum('Y','N') NOT NULL default 'Y' COMMENT 'Is this module active',
  PRIMARY KEY  (id),
  KEY idx_name (`name`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='The possible modules';
...
INSERT INTO modules VALUES(1, 'sitemap', '{$lblSitemap|ucfirst}', 'Y');
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Specific settings for a module';
...
INSERT INTO modules_settings VALUES(0, 'site_wide_html', 's:0:"";');
...
INSERT INTO pages VALUES(405, 409, 0, 0, 2, NULL, 'nl', 'Links', '<p>Links</p>', 'links', 'N', 2, 'N', 'Y', 1, '2008-11-11 19:13:41', '2008-11-11 19:13:41', 'Y', 'Y', 'Y', 'Y', 'Y');
INSERT INTO pages VALUES(406, 2, -2, 1, 3, 1, 'nl', 'Sitemap', '<p>Sitemap</p>', 'sitemap', 'N', 1, 'N', 'Y', 1, '2008-11-12 14:31:01', '2008-11-12 14:31:01', 'Y', 'Y', 'Y', 'Y', 'Y');
...
CREATE TABLE IF NOT EXISTS pages_extras (
  ...
  `action` varchar(255) default NULL COMMENT 'The location of the extra',
...
INSERT INTO pages_extras VALUES(1, 1, '{$lblSitemap|ucfirst}', NULL, 'a:2:{i:0;s:23:"http://blog.verkoyen.eu";i:1;s:21:"http://crsolutions.be";}', 1, 'N');
...
CREATE TABLE IF NOT EXISTS pages_templates (
  ...
  path varchar(255) NOT NULL COMMENT 'The location of the template',
  PRIMARY KEY  (id)
...
INSERT INTO pages_templates VALUES(1, '{$lblHomepageTemplate|ucfirst}', 'core/layout/templates/home.tpl');
