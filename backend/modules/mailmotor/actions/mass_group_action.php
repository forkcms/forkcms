...
class BackendMailmotorMassGroupAction extends BackendBaseAction
{
	...
	public function execute()
	{
		...
		// no id's provided
		if(!isset($_GET['id'])) return $this->redirect(BackendModel::createURLForAction('groups') . '&error=no-selection');
		...
		// redirect
		return $this->redirect(BackendModel::createURLForAction('groups') . '&report=delete-groups');
	}
}
