...
final class BackendMailmotorConfig extends BackendBaseConfig
{
	...
	public function __construct($module)
	{
		...
		if($url != null && $url->getAction() != 'settings' && $url->getAction() != 'import_groups' && SpoonFilter::getPostValue('link_account', null, false) === false && SpoonFilter::getPostValue('load_client_info', null, false) === false)
		{
