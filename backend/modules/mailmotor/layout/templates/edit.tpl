					...
					{iteration:templates}
						<li{option:templates.selected} class="selected"{/option:templates.selected}>
							...
							<label for="{$templates.id}">
								<img src="{$SITE_RELATIVE_URL}/backend/modules/mailmotor/templates/{$templates.language}/{$templates.value}/images/thumb.jpg" width="172" height="129" alt="{$templates.label|ucfirst}" />
