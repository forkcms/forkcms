...
<div class="pageTitle">
	...
	<div class="buttonHolderRight">
		{option:showAddAddress}<a href="{$var|geturl:'add_address'}{option:group}&amp;group_id={$group.id}{/option:group}" class="button icon iconMailAdd"><span>{$lblAddEmail|ucfirst}</span></a>{/option:showAddAddress}
		{option:showImportAddresses}<a href="{$var|geturl:'import_addresses'}{option:group}&amp;group_id={$group.id}{/option:group}" class="button icon iconFolderAdd"><span>{$lblImportAddresses|ucfirst}</span></a>{/option:showImportAddresses}
		{option:showExportAddresses}<a href="{$var|geturl:'export_addresses'}&amp;id={option:!group}all{/option:!group}{option:group}{$group.id}{/option:group}" class="button icon iconExport"><span>{$lblExportAddresses|ucfirst}</span></a>{/option:showExportAddresses}
	</div>
</div>
