                ...
                if ($type == '') {
                    ...
                    if ($type == 'textbox') {
                        ...
                        if ($required == 'Y' && $requiredErrorMessage == '') {
                            $errors['required_error_message'] = BL::getError(
                                                                  'ErrorMessageIsRequired'
                            );
                        }
                        if ($validation != '' && $errorMessage == '') {
                            $errors['error_message'] = BL::getError(
                                                         'ErrorMessageIsRequired'
                            );
                        }
                    } // validate textarea
                    ...
                    if (!empty($errors)) {
                        ...
                        if ($validation != '') {
                            ...
                            $validate['parameter']     = ($validationParameter != '') ? SpoonFilter::htmlspecialchars(
                                                                                                   $validationParameter
                            ) : null;
                        ...
                        $this->output(
                             self::OK,
                                 array('field_id' => $fieldId, 'field_html' => $fieldHTML),
                                 'field saved'
                        );
                    }
                }
