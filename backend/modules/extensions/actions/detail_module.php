...
class BackendExtensionsDetailModule extends BackendBaseActionIndex
{
	...
	private function loadData()
	{
		...
		if(!BackendModel::isInstalledModule($this->currentModule))
		{
	...
	protected function parse()
	{
		...
		$this->tpl->assign('showExtensionsInstallModule', !BackendModel::isInstalledModule($this->currentModule) && BackendAuthentication::isAllowedAction('install_module'));
