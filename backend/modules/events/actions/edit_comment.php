 ...
 */
class BackendEventsEditComment extends BackendBaseActionEdit
{
	/**
	 * Execute the action
	 */
	...
	{
		// get the record
		$this->record = (array) BackendEventsModel::getComment($this->id);
	...
	private function loadForm()
	{
		...
		// assign URL
		$this->tpl->assign('itemURL', BackendModel::getURLForBlock('events', 'detail') . '/' . $this->record['event_url'] . '#comment-' . $this->record['event_id']);
