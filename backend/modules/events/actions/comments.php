...
class BackendEventsComments extends BackendBaseActionIndex
{
	...
	{
		// reset URL
		$URL = BackendModel::getURLForBlock('events', 'detail') . '/' . $URL . '#comment-' . $id;
	...
	private function loadDataGrids()
	{
		...
		$this->dgPublished->setColumnFunction(array('BackendEventsComments', 'addPostData'), array('[text]', '[event_title]', '[event_url]', '[id]'), 'text', true);
		...
		$this->dgModeration->setColumnFunction(array('BackendEventsComments', 'addPostData'), array('[text]', '[event_title]', '[event_url]', '[id]'), 'text', true);
		...
		$this->dgSpam->setColumnFunction(array('BackendEventsComments', 'addPostData'), array('[text]', '[event_title]', '[event_url]', '[id]'), 'text', true);
