...
class BackendTagsMassAction extends BackendBaseAction
{
	...
	public function execute()
	{
		...
		// no id's provided
		if(!isset($_GET['id'])) return $this->redirect(BackendModel::createURLForAction('index') . '&error=no-selection');
		...
		// redirect
		return $this->redirect(BackendModel::createURLForAction('index') . '&report=deleted');
	}
}
