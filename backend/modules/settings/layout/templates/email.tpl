		...
		<div class="options">
			...
			<p>
				...
				<small>
					...
					<span id="testEmailConnectionSpinner" style="display: none;"><img style="margin-top: 3px;" src="{$SITE_RELATIVE_URL}/backend/core/layout/images/spinner.gif" width="12px" height="12px" alt="loading" /></span>
