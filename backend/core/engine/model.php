...
class BackendModel extends BaseModel
{
     ...
     * @param array $data Containing extra variables, will be saved as serialized.
     ...
     */
    public static function insertExtra($type, $module, $action, $label, $data, $hidden = false, $sequence = null)
    {
        // recast variables
        $type = (string) $type;
        $module = (string) $module;
