...
class CommonCookie extends SpoonCookie
{
     ...
     * @param        string    [optional] $path         The path on the server in which the cookie will be available.
     *                                                  Use / for the entire domain, /foo if you just want it to be
     *                                                  available in /foo.
     * @param        string    [optional] $domain       The domain that the cookie is available on. Use .example.com to
     *                                                  make it available on all subdomains of example.com.
     * @param        bool      [optional] $secure       Should the cookie be transmitted over a HTTPS-connection? If
     *                                                  true, make sure you use a secure connection, otherwise the
     *                                                  cookie won't be set.
     * @param        bool      [optional] $httpOnly     Should the cookie only be available through HTTP-protocol? If
     *                                                  true, the cookie can't be accessed by Javascript, ...
